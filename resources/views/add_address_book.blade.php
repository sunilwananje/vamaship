    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-success">
                <div class="panel-heading">Add Address Book</div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('address.store') }}">
                      ...
                      <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        ...
                        <div class="form-group{{ $errors->has('person_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="person_name" type="text" class="form-control" name="person_name" value="{{ old('person_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('person_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="person_phone" type="text" class="form-control" name="person_phone" value="{{ old('person_phone') }}">
                        ...
                        <div class="form-group{{ $errors->has('address_line2') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('address_line3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address_line3" type="text" class="form-control" name="address_line3" value="{{ old('address_line3') }}">
